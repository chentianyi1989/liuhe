...
@section('content')
	...
	<form action="{{ route('case.save')}}" method="post" class="form form-horizontal" id="form-member-add">
    	...
    	<div class="row cl">
    		<label class="form-label col-xs-4 col-sm-3">shejilinian：</label>
    		<div class="formControls col-xs-8 col-sm-9">
...
//                     console.log("stats:",stats)
        ...
        uploader.onUploadSuccess = function (f,r){
//         	console.log("f:",f);
//             console.log("r:",r);
            
            $inp=$("<input name='tuping[]' type=''>")//hidden
            alert(r.result)
            $inp.val(r.result)
            $("#imgPath").append($inp);
        }
